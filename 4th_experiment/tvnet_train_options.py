...
class arguments():
    ...
    def initialize(self):
        ...
        self.argparser.add_argument('--n_epoch', type=int, default=2, help='number of epochs')
        self.argparser.add_argument('--n_threads', type=int, default=100, help='number of threads for dataloader')
        self.argparser.add_argument('--batch_size', type=int, default=40, help='just batch size')
        self.argparser.add_argument('--learning_rate', type=float, default=0.005, help='learning rate') # orig. .005
        ...
        self.argparser.add_argument('--n_warps', type=int, default=3, help='number of warpings per scale')
