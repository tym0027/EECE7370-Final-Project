...
classifier_ckpt_file = '/storage/truppr/models/10classExperiment/UCFModel88.pth' # './DyanC.pth'
...
# set test list name:
validateFolderFile = 'validatelist10.txt'
# set test data directory:
# rootDir = '/storage/truppr/UCF-FLOWS-FULL/'
rootDir = '/data/Abhishek/frames/'

# for UCF dataset:
validateFoldeList = getListOfFolders(validateFolderFile) # [::2]
