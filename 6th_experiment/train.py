...
from utils import videoDatasetPreGenOFandRGB #, videoDatasetPreGenOF
...
checkptname = "2Stream-DYAN-ResNet"
ckpt_file = '/storage/truppr/models/experiment6/2Stream-DYAN-ResNet48.pth'


## Load input data
# set train list name:
trainFolderFile = 'trainlist05.txt'
...
trainingData = videoDatasetPreGenOFandRGB(folderList=trainFoldeList, rootDirPGOF=rootDirOF, rootDirRGB=rootDirRGB, N_FRAME=N_FRAME) # for pre-generated OF
...
for epoch in range(start_epoch, EPOCH+1):
	...
	for i_batch, sample in enumerate(dataloader):
		''' Raw Frames Loading '''
		dataRGB = sample['frames'].cuda(gpu_id)
		dataOF = sample['of'].cuda(gpu_id)
		...
		output = model.forward(inputDataRGB.squeeze(0), inputDataOF.squeeze(0))
